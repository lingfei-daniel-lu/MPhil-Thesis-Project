...
\input{chapter/sec-1.introduction}
\input{chapter/sec-2.literature}
\input{chapter/sec-3.data}
\input{chapter/sec-4.framework}
\input{chapter/sec-5.results}
\input{chapter/sec-6.robustness}
\input{chapter/sec-7.discussion}
\input{chapter/sec-8.conclusion}
